/**
 * shared.js — Firebase init + shared UI utilities
 * NOTE: No firebase.storage() — images go to Cloudinary
 */
...
/* ── Falling petals ── */
window.spawnPetals = function(containerId, count) {
  count = count || 18;
  var c = document.getElementById(containerId);
  if (!c) return;
  var colors = ['#7ec0e0','#4a9fd4','#b4d8ee','#2d78c0','#d8eef8','#edf6fb'];
